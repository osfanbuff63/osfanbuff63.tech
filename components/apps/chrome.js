...
export class Chrome extends Component {
    constructor() {
        super();
        this.home_url = 'https://www.duckduckgo.com/webhp?igu=1';
        this.state = {
            url: 'https://www.duckduckgo.com/webhp?igu=1',
            display_url: "https://www.duckduckgo.com",
        }
    }
    ...
    goToHome = () => {
        this.setState({ url: this.home_url, display_url: "https://www.duckduckgo.com" });
        this.refreshChrome();
    }

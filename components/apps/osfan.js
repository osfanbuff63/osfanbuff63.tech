...
export class AboutOsfan extends Component {
        ...
        return (
            <>
                ...
                <div className='my-0.5 w-28 md:w-full h-8 px-2 md:px-2.5 flex' >
                    <iframe src="https://github.com/sponsors/osfanbuff63/button" title="Sponsor osfanbuff63" width={"100%"} height={"100%"} ></iframe>
                </div>
            </>
        );
    }
...
export default AboutOsfan;

export const displayAboutOsfan = () => {
    return <AboutOsfan />;
}
    ...
    return (
        <>
            <div className="w-20 md:w-28 my-4 bg-white rounded-full">
                <img className="w-full" src="./images/logos/fevicon.png" alt="osfanbuff63 Logo" />
            </div>
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>I'm <span className="font-bold">osfanbuff63</span> ,</div>
            ...
            <div className="w-full md:w-10/12 flex justify-center items-start font-bold text-center">
                <div className="px-2 w-1/2">
                    <div className="flex flex-wrap justify-center items-start w-full mt-2">
                        ...
                        <a href="https://www.duckduckgo.com/search?q=is+html+a+language%3F" target="_blank" rel="noreferrer"><img title="yes it's a language!" className="m-1" src="https://img.shields.io/badge/-HTML5-%23E44D27?style=flat&logo=html5&logoColor=ffffff" alt="vivek HTML" /></a>
...
function Projects() {
    const project_list = [
        {
            ...
            date: "Apr 2021",
            link: "https://github.com/osfanbuff63/osfanbuff63.github.io",
            description: [
        ...
        },
        {
            ...
            date: "Dec 2021",
            link: "https://github.com/osfanbuff63/chrome-extension-react-boilerplate",
            description: [
        ...
        },
        {
            name: "CodeConnect",
            date: "Nov 2021",
            link: "https://github.com/osfanbuff63/CodeConnect-frontend",
            description: [
        ...
        },
        {
            ...
            date: "Jun 2021",
            link: "https://github.com/osfanbuff63/ad-free-spotify",
            description: [
        ...
        },
        {
            ...
            date: "Mar 2021",
            link: "https://github.com/osfanbuff63/economist.com-unlocked",
            description: [
        ...
        },
        {
            ...
            date: "Jan 2021",
            link: "https://github.com/osfanbuff63/flutter-banking-app",
            description: [
        ...
        },
        {
            ...
            date: "Dec 2020",
            link: "https://github.com/osfanbuff63/CPU-Scheduling-APP-React-Native",
            description: [
        ...
        },
        {
            ...
            date: "Nov 2020",
            link: "https://github.com/osfanbuff63/Meditech-Healthcare",
            description: [
        ...
        },
        {
            ...
            date: "Sep 2020",
            link: "https://github.com/osfanbuff63/Improve-Codeforces",
            description: [
    ...
    return (
        <>
            ...
            <iframe src="https://github.com/sponsors/osfanbuff63/card" title="Sponsor osfanbuff63" className='my-4 w-5/6 md:w-3/4' ></iframe>
                            ...
                            <div className="w-full py-1 px-2 my-2 border border-gray-50 border-opacity-10 rounded hover:bg-gray-50 hover:bg-opacity-5 cursor-pointer">
                                <div className="flex flex-wrap justify-between items-center">
                                    <div className='flex justify-center items-center'>
                                        ...
                                        <iframe src={`https://ghbtns.com/github-btn.html?user=osfanbuff63&repo=${projectName}&type=star&count=true`} frameBorder="0" scrolling="0" width="150" height="20" title={project.name.toLowerCase()+"-star"}></iframe>
                                    </div>
...
function Resume() {
    return (
        <iframe className="h-full w-full" src="./files/Vivek-Patel-Resume.pdf" title="osfanbuff63 resume" frameBorder="0"></iframe>
    )
}
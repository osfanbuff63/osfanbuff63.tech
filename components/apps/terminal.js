...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            skills: ["(some) Front-end development", "Anything Python", "Moderation"],
            projects: ["osfanbuff63-personal-portfolio", "ws-datapack", "fabulously-optimized", "vanilla-installer", "minecraft-datapack"],
            interests: ["Software Developing", "Deep Learning", "Computer Vision"],
            languages: ["Svelte (learning)", "Python", "mcfunction"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">osfanbuff63@osfannewpc-linux-ubuntu</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/osfanbuff63")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-osfanbuff63, todoist, trash, settings, sendmsg]";
                }
                break;
            case "vscode":
                if (words[0] === "." || words.length === 0) {
            ...
            case "trash":
                ...
                break;
            case "about-osfanbuff63":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-osfanbuff63");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-osfanbuff63, todoist, trash, settings, sendmsg ]";
                }
                break;
            ...
            case "sendmsg":
                ...
                break;
            case "apt":
                result = "Nope, no installing packages. 😜"
                break;
            case "bash":
                result = "Bash v5.2 running on ubuntu."
                break;
            case "clear":
                this.reStartTerminal();
                return;
            case "exit":
                ...
                return;
            case "sudo":
                result = "Don't you try to break me like that! 😅\n";
                break;
            default:
                result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-osfanbuff63, todoist, trash, settings, sendmsg ]";
        }
